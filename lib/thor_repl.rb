...
module ThorRepl
  ...
  def self.start(thor_command_class, history: true, prompt: ">", history_file_path: HISTORY_FILE_PATH)
    load_readline

    looper = self.new(thor_command_class: thor_command_class, prompt: prompt)
